    ...
    <div class="gallery padding--top padding--bottom bg-light">
        <div class="container">
            <div class="section__header text-center">
                <h2>GALERÍA DE LOS MISIONEROS</h2>
         </div>
            <div class="section__wrapper">
                <div class="gallery__filter">
                    <ul>
                        <li data-filter="*" class="active">Todo</li>
                        <li data-filter=".cate-1">Médico</li>
                        <li data-filter=".cate-2">Navidad</li>
                        <li data-filter=".cate-3">programa</li>
                        <li data-filter=".cate-4">Reunion</li>
                        <li data-filter=".cate-5">Misioneros</li>
                    </ul>
                </div>
                <div class="row g-3 grid">
                        ...
                        <div class="gallery__item">
                            <div class="gallery__inner">
                                ...
                                <div class="gallery__content text-center">
                                    ...
                                    <a href="https://www.facebook.com/IglepueblodeDios/photos/pcb.4935203266596825/4935191229931362" target="_blank" rel="noopener noreferrer" class="gallery__icon"><i class="fas fa-share-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12 cate-4">
                        <div class="gallery__item">
                            <div class="gallery__inner">
                                <div class="gallery__thumb">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12 cate-5">
                        <div class="gallery__item">
                            <div class="gallery__inner">
                                <div class="gallery__thumb">
