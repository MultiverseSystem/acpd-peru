...
<div class="banner__slider banner-style2 overflow-hidden">
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <div class="banner screnn1 screnn2" style="background-image: url(assets/images/banner/1.jpg);height:800px ;">
        ...
        <div class="swiper-slide">
            <div class="banner screnn1 screnn2" style="background-image: url(assets/images/banner/2.jpg);height:800px ;">
        ...
        <div class="swiper-slide">
            <div class="banner screnn1 screnn2" style="background-image: url(assets/images/banner/3.jpg);height:800px ;">
                <div class="container d-flex justify-content-start">
                    <div class="banner__content  row ">
                        <div class="fs-4">
                            <h1 style="font-family: Roboto,sans-serif;" class="text-white fw-bold">CAMINO MISIONERO</h1>
                            <p class="text-white">LLEVAMOS A TODOS LA PALABRA DE DIOS.</p>
    ...
    <div class="container-fluid">
        ...
        <div class="section__wrapper">
            <div class="row g-3 grid">
                    ...
                    <div class="gallery__item">
                        <div class="gallery__inner">
                            ...
                            <div class="gallery__thumb">
                                <img src="assets/images/gallery/1.jpg" alt="gallery-thumb" class="w-100">
                            </div>

                            <div class="gallery__content text-center">
                                <a href="assets/images/gallery/1.jpg" data-rel="lightcase" class="gallery__icon"><i class="fas fa-plus"></i></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 cate-2">
                    <div class="gallery__item">
                        <div class="gallery__inner">
                            <div class="gallery__thumb">
                                <img src="assets/images/gallery/2.jpg" alt="gallery-thumb" class="w-100">
                            </div>
                            <div class="gallery__content text-center">
                                <a href="assets/images/gallery/2.jpg" data-rel="lightcase" class="gallery__icon"><i class="fas fa-plus"></i></a>
                                <a href="https://es-la.facebook.com/IglepueblodeDios/" target="_blank" rel="noopener noreferrer" class="gallery__icon"><i class="fas fa-share-alt"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12 cate-3">
                    <div class="gallery__item">
                        <div class="gallery__inner">
                            <div class="gallery__thumb">
                                <img src="assets/images/gallery/3.jpg" alt="gallery-thumb" class="w-100">
                            </div>
                            <div class="gallery__content text-center">
                                <a href="assets/images/gallery/3.jpg" data-rel="lightcase" class="gallery__icon"><i class="fas fa-plus"></i></a>
                                <a href="https://es-la.facebook.com/IglepueblodeDios/" target="_blank" rel="noopener noreferrer" class="gallery__icon"><i class="fas fa-share-alt"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12 cate-4 cate-1">
                    <div class="gallery__item">
                        <div class="gallery__inner">
                            <div class="gallery__thumb">
                                <img src="assets/images/gallery/4.jpg" alt="gallery-thumb" class="w-100">
                            </div>
                            <div class="gallery__content text-center">
                                <a href="assets/images/gallery/4.jpg" data-rel="lightcase" class="gallery__icon"><i class="fas fa-plus"></i></a>
                                <a href="https://es-la.facebook.com/IglepueblodeDios/" target="_blank" rel="noopener noreferrer" class="gallery__icon"><i class="fas fa-share-alt"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12 cate-3">
                    <div class="gallery__item">
                        <div class="gallery__inner">
                            <div class="gallery__thumb">
                                <img src="assets/images/gallery/5.jpg" alt="gallery-thumb" class="w-100">
                            </div>
                            <div class="gallery__content text-center">
                                <a href="assets/images/gallery/5.jpg" data-rel="lightcase" class="gallery__icon"><i class="fas fa-plus"></i></a>
                                <a href="https://es-la.facebook.com/IglepueblodeDios/" target="_blank" rel="noopener noreferrer" class="gallery__icon"><i class="fas fa-share-alt"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12 cate-2 cate-4">
                    <div class="gallery__item">
                        <div class="gallery__inner">
                            <div class="gallery__thumb">
                                <img src="assets/images/gallery/6.jpg" alt="gallery-thumb" class="w-100">
                            </div>
                            <div class="gallery__content text-center">
                                <a href="assets/images/gallery/6.jpg" data-rel="lightcase" class="gallery__icon"><i class="fas fa-plus"></i></a>
                                <a href="https://es-la.facebook.com/IglepueblodeDios/" target="_blank" rel="noopener noreferrer" class="gallery__icon"><i class="fas fa-share-alt"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-5">
                <a href="galeria.php" class="default-btn move-right"><span>VER MÁS</span></a>
            </div>
        </div>
    </div>
</div>
